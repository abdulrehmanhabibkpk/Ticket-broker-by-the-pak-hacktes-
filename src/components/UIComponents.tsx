...
export function TableSkeleton() {
  return (
    <div className="w-full space-y-4">
      {/* Header row */}
      <div className="flex space-x-4 border-b border-gray-100 pb-3">
      ...
      {Array.from({ length: 4 }).map((_, i) => (
        <div key={i} className="flex space-x-4 py-3 items-center">
...
export function CardSkeleton() {
  return (
    <div className="p-6 border border-gray-100 rounded-xl space-y-4 bg-white shadow-sm">
